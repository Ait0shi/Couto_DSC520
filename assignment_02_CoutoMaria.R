...
dir("C:/Users/ait0s/OneDrive/Documents/Github/dsc520")

## Load the file `data/tidynomicon/person.csv` to `person_df1` using `read.csv`
## Examine the structure of `person_df1` using `str()`

person_df1 <- read.csv(file = "C:/Users/ait0s/OneDrive/Documents/Github/dsc520/data/tidynomicon/person.csv", stringsAsFactors = TRUE)
str(person_df1)
...
person_df2 <- read.csv(file = "C:/Users/ait0s/OneDrive/Documents/Github/dsc520/data/tidynomicon/person.csv", stringsAsFactors = FALSE)
str(person_df2)
...
excel_sheets("C:/Users/ait0s/OneDrive/Documents/Github/dsc520/data/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("C:/Users/ait0s/OneDrive/Documents/Github/dsc520/data/G04ResultsDetail2004-11-02.xls",
                                "Voter Turnout", skip = 1)
...
## Use the names "ward_precinct", "ballots_cast", "registered_voters", "voter_turnout"
## Assign the data to the `voter_turnout_df2`
## Examine the structure of `voter_turnout_df2` using `str()`

voter_turnout_df2 <- read_excel("C:/Users/ait0s/OneDrive/Documents/Github/dsc520/data/G04ResultsDetail2004-11-02.xls",
                                "Voter Turnout", skip = 2)
colnames(voter_turnout_df2) <- c("ward_precinct", "ballots_cast","registered_voters", "voter_turnout")
